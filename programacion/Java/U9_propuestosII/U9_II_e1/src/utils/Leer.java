...
public class Leer {
     ...
     * @return nombre enter introduït per l'usuari
     */
    public int demanarIntOpcio(int minim, int maxim, String missatge) {
        int num = -1;
        boolean correcte = false;
    ...
    public float demanarFloat() {
        ...
        while (!correcte) {
            try {
                real = Float.parseFloat(demanarString("Introduïx un nombre real float: "));
                correcte = true;
            } catch (NumberFormatException e) {
                System.out.println("Error, no has introduït un nombre real float.");
            }
        }
     ...
     * @return double introduït per l'usuari
     */
    public float demanarFloat(String missatge) {
        ...
        while (!correcte) {
            try {
                real = Float.parseFloat(demanarString(missatge));
                correcte = true;
            } catch (NumberFormatException e) {
                System.out.println("Error, no has introduït un nombre real float.");
            }
