...
public class DBManager {
    ...
    public static void crearTablaAutores(){
        ...
        try {
            ...
            try {
                String sql2 = "ALTER TABLE libros ADD COLUMN autor BIGINT(20) REFERENCES autores(id)";
    ...
    public static void insertarDatosIniciales(){
        ...
        try {
            ...
            String sql2 = "UPDATE libros SET autor = 1 WHERE id = 1 OR id = 2 OR id = 4 OR id = 5 OR id = 6;";
            ps = conn.prepareStatement(sql2);
            ps.executeUpdate();

            String sql3 = "UPDATE libros SET autor = 2 WHERE id = 2;";
